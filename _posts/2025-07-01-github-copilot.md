...
I had originally written this post to express my disappointment at GitHub Copilot. That version came down to one paragraph:
...
This one feels like a leap rather than a minor update. The agent chains actions together, holds context, and stays with a whole task instead of helping with a block of code and disappearing. It carries a thread from start to finish.

The gap between tool and partner is shrinking fast, and the models will keep getting better. Some tasks that used to take an afternoon are done before you've finished your coffee.
...
This looks like the start of another shift in how teams work, where less time goes on glue and more goes on the product itself.
