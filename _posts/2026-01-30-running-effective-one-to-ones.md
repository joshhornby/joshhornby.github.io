...
A 1:1 is a conversation about how someone is doing, what they're learning, where they're struggling, and where they want to go. It's the one meeting that's explicitly about them, not about the work. As Camille Fournier puts it in [The Manager's Path](/notes-on-a-managers-path), 1:1s create "a human connection" and provide "a regular opportunity for private discussion."
