...
sitemap:
  priority: 0.7
  changefreq: 'monthly'
  lastmod: "2026-01-27T08:00:00+00:00"
---
...
You shouldn't write so much code that you become a bottleneck. If the team waits for your PRs, if you're on the critical path for every feature, if nothing ships when you're on holiday, you're writing too much. Remember: [the goal is to make yourself less necessary over time](/what-is-a-tech-lead#the-multiplier-test).
...
- Infrastructure and tooling that [multiplies everyone's output](/doing-leveraged-work)
