...
sitemap:
    priority: 0.7
    changefreq: 'monthly'
    lastmod: "2026-01-04T10:00:00+01:00"
---

Progress tracking has a problem at its root: it combines two different kinds of work. There's work where you know what to do and just need to do it. And there's work where you're still figuring out what "done" even looks like. Percentage complete treats these as interchangeable. They aren't.
...
Communicating with senior stakeholders. Executives understand the difference between "we're still figuring out the approach" and "we know what to do, it's just taking time". A percentage doesn't carry that.
