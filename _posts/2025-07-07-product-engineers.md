...
The industry has been moving towards full-stack engineers for years, but I think we're solving for the wrong thing. We don't need engineers who can work across the entire technical stack. We need engineers who can work across the entire value stack, from customer problem to business impact.
...
Most organisations discourage Product Engineering without meaning to. Promotion systems often reward technical complexity over customer impact. Team structures can create walls between engineers and users. Planning processes assume requirements flow in one direction.
...
What I've seen work is creating the conditions where Product Engineering can emerge.

Give engineers direct access to impact data. At one company we gave everyone access to revenue dashboards, support tickets and usage analytics, with no request process and no sanitised summaries. When an engineer could see their feature had driven £200K in new revenue, or that customers were struggling with their new flow, behaviour changed quickly.

Make it safe to challenge requirements. The best Product Engineers I've worked with had managers who backed them when they questioned a feature. "I talked to five customers and none of them need this" has to be a valid argument, even late in the planning cycle.

Give them time to follow through. Amazon famously has engineers carry pagers for their services. The Product Engineering equivalent is owning your feature through its first month of real usage. If you build it, you should see how it lands.
...
I've seen a single Product Engineer shift a whole team's dynamic. Once other engineers see the clarity and the recognition that comes with working this way, they start doing the same, and nobody has to mandate it.

Companies that figure this out will have an advantage, because they'll be solving real problems rather than shipping more features. As AI handles more of the mechanical parts of software development, working out what to build matters more.
